...
from controller.models import User, Subject, Quiz, Question, Attempt
...
def home():
    ...
    return render_template(
        "user_dashboard.html",subjects_count=subjects_count, quizzes_count=quizzes_count, questions_count=questions_count, attempted_count=attempted_count
    )
